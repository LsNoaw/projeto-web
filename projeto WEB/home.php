...
<div class="container">
    ...
    <center><span>Depressão: Uma Jornada de Autoconhecimento e Resiliência</span></center>
     ...
     <img src="https://i.em.com.br/wDGKR6d9y51f48HmXqi8KdF6I98=/820x0/smart/imgsapp.em.com.br/app/noticia_127983242361/2019/10/28/1096373/20191028103129567342i.jpg" alt="">
    ...
    <center><span class="desc">A depressão é uma condição de saúde mental que afeta profundamente o bem-estar emocional de uma pessoa. Caracterizada por sentimentos persistentes de tristeza, <br>desespero e perda de interesse em atividades cotidianas, a depressão pode ter um impacto significativo na vida diária e nas relações interpessoais. <br> É uma condição séria, mas tratável, que exige compreensão, apoio e tratamento adequado.</span></center>
        ...
        <div class="pageline">
            <div>
                <h2>Modulos:</h2>
                <ol>
                    <a href="modulo1.php"><li><h3>Informações detalhadas sobre o que é a depressão.</h3></li></a>
                    <a href="modulo2.php"><li><h3>Sintomas comuns da depressão</h3></li></a>
                    <a href="modulo3.php"><li><h3>Fatores de risco e causas da depressão</h3></li></a>
            ...
            <div class="pageline2">
                ...
                <ol>
                    <a href="profissionais1.php"><li><h3>Uma lista de terapeutas, psicólogos e psiquiatras locais que podem ajudar no tratamento da depressão.</h3></li></a>
                    <a href="Dicas.php"><li><h3>Livros de Auto-ajjuda.</h3></li></a>
